...
void main() {
  // strems
  contaInscritos()
      .listen((val) => print('Inscritos: $val'), //   Escutando o Stream
          onDone: () => print('Stream finalizado')); //   Stream finalizado

  print("Cheguei no final");
}

Stream<int> contaInscritos() async* {
  // Stream finalizado
  for (int i = 1; i <= 10; i++) {
    yield i;
...
// COMENTE O CODIGO ACIMA E DESCOMENTE O ABAIXO PARA TESTAR O streamController.
